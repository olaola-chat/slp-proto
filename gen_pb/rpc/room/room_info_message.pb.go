...
func (x *ReqUid) Reset() {
	*x = ReqUid{}
	if protoimpl.UnsafeEnabled {
		mi := &file_rpc_room_room_info_message_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ReqUid) Descriptor() ([]byte, []int) {
	return file_rpc_room_room_info_message_proto_rawDescGZIP(), []int{4}
}
...
func (x *RepRid) Reset() {
	*x = RepRid{}
	if protoimpl.UnsafeEnabled {
		mi := &file_rpc_room_room_info_message_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*RepRid) Descriptor() ([]byte, []int) {
	return file_rpc_room_room_info_message_proto_rawDescGZIP(), []int{5}
}
...
var file_rpc_room_room_info_message_proto_rawDesc = []byte{
	...
	0x43, 0x68, 0x61, 0x74, 0x72, 0x6f, 0x6f, 0x6d, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0x1a,
...
func file_rpc_room_room_info_message_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_rpc_room_room_info_message_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ReqUid); i {
			case 0:
				return &v.state
			case 1:
		...
		file_rpc_room_room_info_message_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*RepRid); i {
			case 0:
				return &v.state
			case 1:
