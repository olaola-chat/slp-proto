...
func (x *ReqGetRecAlbums) GetPage() uint32 {
	if x != nil {
		return x.Page
	}
	return 0
...
func (x *ReqGetRecAlbums) GetLimit() uint32 {
	if x != nil {
		return x.Limit
	}
	return 0
...
func (x *ResGetRecAlbums) GetHasMore() bool {
	if x != nil {
		return x.HasMore
	}
	return false
...
var file_rpc_voice_lover_voice_lover_message_proto_rawDesc = []byte{
	...
	0x09, 0x52, 0x06, 0x6c, 0x61, 0x62, 0x65, 0x6c, 0x73, 0x22, 0x4d, 0x0a, 0x0f, 0x52, 0x65, 0x71,
	...
	0x0d, 0x52, 0x05, 0x6c, 0x69, 0x6d, 0x69, 0x74, 0x22, 0x64, 0x0a, 0x0f, 0x52, 0x65, 0x73, 0x47,
	...
	0x02, 0x20, 0x01, 0x28, 0x08, 0x52, 0x07, 0x68, 0x61, 0x73, 0x4d, 0x6f, 0x72, 0x65, 0x22, 0x21,
	...
	0x28, 0x0d, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x42, 0x39, 0x5a,
...
var file_rpc_voice_lover_voice_lover_message_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_rpc_voice_lover_voice_lover_message_proto_goTypes = []interface{}{
	...
	nil,                                // 10: rbp.rpc.voice_lover.ResBatchGetAlbumAudioCount.AlbumCountsEntry
	(*AlbumData)(nil),                  // 11: rbp.rpc.voice_lover.AlbumData
	(*AudioEditData)(nil),              // 12: rbp.rpc.voice_lover.AudioEditData
	(*AudioData)(nil),                  // 13: rbp.rpc.voice_lover.AudioData
}
var file_rpc_voice_lover_voice_lover_message_proto_depIdxs = []int32{
	11, // 0: rbp.rpc.voice_lover.ResGetRecAlbums.albums:type_name -> rbp.rpc.voice_lover.AlbumData
	12, // 1: rbp.rpc.voice_lover.ResGetAudioEdit.edits:type_name -> rbp.rpc.voice_lover.AudioEditData
	13, // 2: rbp.rpc.voice_lover.ResGetAudioDetail.audio:type_name -> rbp.rpc.voice_lover.AudioData
	10, // 3: rbp.rpc.voice_lover.ResBatchGetAlbumAudioCount.album_counts:type_name -> rbp.rpc.voice_lover.ResBatchGetAlbumAudioCount.AlbumCountsEntry
